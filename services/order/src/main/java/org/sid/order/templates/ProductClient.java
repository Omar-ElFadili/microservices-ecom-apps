package org.sid.order.templates;

import jakarta.validation.Valid;
import jdk.dynalink.linker.LinkerServices;
import lombok.RequiredArgsConstructor;
import org.sid.order.dtos.PurchaseRequest;
...
public class ProductClient {
    ...
    public List<PurchaseResponse> purchaseProducts(List<PurchaseRequest> purchaseRequests){
        ...
        if(responseEntity.getStatusCode().isError()){
            throw new BusinessNotFoundException("an error occured while processing purchase");
        }
