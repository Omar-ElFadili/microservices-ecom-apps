package org.sid.notification.services.email;

import jakarta.mail.MessagingException;
import jakarta.mail.internet.MimeMessage;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.sid.notification.enums.EmailTemplate;
import org.sid.notification.kafka.models.Product;
...
import static org.sid.notification.enums.EmailTemplate.ORDER_CONFIRMATION;
import static org.sid.notification.enums.EmailTemplate.PAYMENT_CONFIRMATION;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail, String customerName,
        ...
        mimeMessageHelper.setFrom("omarelfadili19@gmail.com");
        ...
        try {
            ...
            log.warn("WARNING, can not sent email to {}", destinationEmail, exception);
        }
